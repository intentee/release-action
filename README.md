...
Validates a release tag (`v1.2.3` or `v1.2.3-rc1`), extracts the semantic version, and reads the annotated tag message. Outputs `type` (RELEASE/PRE_RELEASE), `version`, `name`, and `description`.
